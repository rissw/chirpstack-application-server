...
const t = (key) => {
  return translate("OrganizationLayoutJS", key);
};
  ...
  render() {
    ...
    return (
      <Grid container spacing={4}>
        ...
        >
          <TitleBarTitle to="/organizations" title={t("Organizations")} />
          <TitleBarTitle title="/" />
        ...
        <Grid item xs={12}>
          ...
          >
            <Tab
              label={t("Dashboard")}
              component={Link}
              to={`/organizations/${this.props.match.params.organizationID}`}
            />
            <Tab
              label={t("Configuration")}
              component={Link}
              to={`/organizations/${this.props.match.params.organizationID}/edit`}
            />
          </Tabs>
        </Grid>
            ...
            <Route
              ...
              render={(props) => (
                <OrganizationDashboard
                  organization={this.state.organization.organization}
                  {...props}
                />
              )}
            />
