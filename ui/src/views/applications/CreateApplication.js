...
const t = (key) => {
  return translate("CreateApplicationJS", key);
};
        ...
        <Dialog open={this.state.spDialog} onClose={this.closeDialog}>
          ...
          <DialogContent>
            <DialogContentText paragraph>
              The selected organization does not have a service-profile yet. A
              service-profile connects an organization to a network-server and
              defines the features that an organization can use on this
              network-server.
            </DialogContentText>
            <DialogContentText>
