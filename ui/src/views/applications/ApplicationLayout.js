...
const t = (key) => {
  return translate("ApplicationLayoutJS", key);
};
    ...
    if (window.confirm(t("DeleteConfirmation"))) {
      ApplicationStore.delete(this.props.match.params.applicationID, (resp) => {
        this.props.history.push(
          `/organizations/${this.props.match.params.organizationID}/applications`
        );
      });
    }
  }
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          ...
          >
            ...
            {this.state.admin && (
              <Tab
                label={t("ApplicationConfiguration")}
                component={Link}
                to={`/organizations/${this.props.match.params.organizationID}/applications/${this.props.match.params.applicationID}/edit`}
              />
            )}
            {this.state.admin && (
              <Tab
        ...
        <Grid item xs={12}>
          <Switch>
            ...
            <Route
              ...
              render={(props) => <CreateAWSSNSIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/aws-sns/edit`}
              render={(props) => <UpdateAWSSNSIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/gcp-pubsub/create`}
              render={(props) => <CreateGCPPubSubIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/gcp-pubsub/edit`}
              render={(props) => <UpdateGCPPubSubIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/http/create`}
              render={(props) => <CreateHTTPIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/http/edit`}
              render={(props) => <UpdateHTTPIntegration {...props} />}
            />
            <Route
              exact
              path={`${this.props.match.path}/integrations/azure-service-bus/create`}
              render={(props) => (
                <CreateAzureServiceBusIntegration {...props} />
              )}
            />
            <Route
              exact
